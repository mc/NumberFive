...
class Misc_generator
    ...
    def history_diff( titles, rvlimit = 30, rvprop = "timestamp|comment|user|size", rvstartid = nil, rvendid = nil, rvdir = "older", rvuser= nil, diffto = "prev")
        ...
        finish = false
        while !finish
            result = @site.query_prop_revisions(:titles => titles, :rvprop => rvprop, :rvlimit => rvlimit, :rvstartid => rvstartid, :rvendid => rvendid, 
		:rvdir => rvdir, :rvuser => rvuser, :rvdiffto => "prev")
